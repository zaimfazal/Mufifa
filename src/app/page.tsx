              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    This challenge is part of MuLearn. Participants who submit their ML notebook, methodology, and final predictions in the MuLearn Discord community will receive μLearn Karma Points. If you are not part of the MuLearn community, please register through <a href="https://mulearn.org" target="_blank" rel="noopener noreferrer" className="underline hover:text-primary transition-colors">mulearn.org</a>.
                  </p>
                </div>
              </div>
